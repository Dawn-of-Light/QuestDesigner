...
{
    [Modul(true, true)]
    public class DatabaseMobModule : AbstractObjectModule<Mob>
    {        

        public const string MODULE_NAME = "Database Mobs";        

        public DatabaseMobModule(): base(MODULE_NAME,128,128) {}        
        ...
        private GeometryObj AddMob(Mob mob)
        {            
            ...
            Texture texture = Textures.LoadMapObjectTexture(mob.ClassType , mob.Realm);                        
